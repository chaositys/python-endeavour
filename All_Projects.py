...
while True:
    def welcome():
        ...
        def info_on_tasks(Full_answer):
            ...
            time.sleep(0.4)
            print("The second one makes a random username which uses a set list of names that are joined together and then it makes a random password")
            print("")
            print("*" * 30)
            time.sleep(0.2)
        ...
        def update_logs(Full_answer):
            print("This is the second version and it is in beta so there will be bugs. ")
            time.sleep(0.2)
            print("Username and password generator which is fully random")
            time.sleep(0.2)
            print("If you find any bugs please contact me and report them, Thank you!")
            time.sleep(0.2)
            input("Press enter to go back: ")
            print("*" * 30)
            Full_answer = welcomed(Full_answer)
    ...
    def making_a_carpet():
        ...
        print("An odd number.")
        time.sleep(0.3)
        print("Less than 50 and greater than 5 (can change this in settings): ")
        time.sleep(1)
    ...
    def password_and_username_generator():
        string_e = ["hello", "world", "python", "programming", "example", "computer", "language", "developer", "learning",
                    "knowledge",
                    "coding", "challenge", "algorithm", "data", "science", "intelligence", "machine", "learning",
                    "openai", "gpt-3",
                    "chatbot", "artificial", "neural", "network", "deep", "learning", "creative", "innovation",
                    "technology", "robotics",
                    "automation", "future", "digital", "transformation", "web", "development", "cloud", "computing",
                    "cybersecurity",
                    "blockchain", "cryptocurrency", "bitcoin", "ethereum", "smart", "contract", "decentralized",
                    "finance", "token",
                    "crypto", "wallet", "secure", "privacy", "internet", "of", "things", "augmented", "reality",
                    "virtual", "reality",
                    "smartphone", "tablet", "application", "interface", "user", "experience", "design", "interface",
                    "graphics", "game",
                    "entertainment", "music", "art", "design", "creativity", "inspiration", "innovation", "explore",
                    "discover", "imagine",
                    "create", "inspire", "world", "unity", "diversity", "inclusion", "equality", "sustainability",
                    "environment", "planet",
                    "earth", "ocean", "forest", "wildlife", "conservation", "climate", "change", "global", "warming",
                    "renewable", "energy"]
        ...
        while True:
            if answer == 1:
                list_of_letters = input(
                    "Enter the characters that you want to be in your password (e.g., ABCDEFGHIGabcdefghijklmnopqrstuvwxyz0123456789!@#$%^&*()): ")
                ...
                username = ''.join(
                    random.choice(string_e[numfirst_username][:len(string_e[numfirst_username]) // 2 + 1]) + random.choice(
                        string_e[numsecond_username][len(string_e[numsecond_username]) // 2:]) for i in range(
                        username_length - 1))
